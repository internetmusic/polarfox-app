...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const USDC = chainId ? DAI[chainId] : DAI[ChainId.AVALANCHE] // TODO: USDC != DAI, this could be a mistake
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.AVALANCHE ? USDC : undefined], // TODO: Update this to include other chain IDs
